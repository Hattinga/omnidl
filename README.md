...
[![Neueste Version](https://img.shields.io/github/v/release/Hattinga/omnidl?label=Download&color=0a84ff)](https://github.com/Hattinga/omnidl/releases/latest)
...
Alle Dateien liegen unter **[Releases → neueste Version](https://github.com/Hattinga/omnidl/releases/latest)**.
